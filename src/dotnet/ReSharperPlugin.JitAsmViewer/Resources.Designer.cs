...
namespace ReSharperPlugin.JitAsmViewer
{
  ...
  {
    private static readonly ILogger ourLog = Logger.GetLogger("ReSharperPlugin.JitAsmViewer.Resources");
      ...
      CultureContextComponent.Instance.Change.Advise(Lifetime.Eternal, args =>
      {
          ...
          if (instance != null)
          {
            ourResourceManager = new Lazy<JetResourceManager>(
              ...
              {
                return instance
                  .CreateResourceManager("ReSharperPlugin.JitAsmViewer.Resources", typeof(Resources).Assembly);
              });
          }
          else
          {
    ...
    public static string JitAsmViewerContextActionName => ResourceManager.GetString("JitAsmViewerContextActionName");
    public static string JitAsmViewerContextActionDescription => ResourceManager.GetString("JitAsmViewerContextActionDescription");
    public static string JitAsmViewerContextActionText => ResourceManager.GetString("JitAsmViewerContextActionText");
  }
}